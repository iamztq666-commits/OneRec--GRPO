...
| 实验 | NDCG@10 | ILD | 留存率 |
|------|---------|-----|--------|
| A：离线 baseline（无仿真）| 0.0081 | 0.077 | - |
| B：规则推荐 + 仿真用户 | 0.0940 | 0.104 | 0.074 |
| C：完整系统（SFT+GRPO）| 0.0900 | 0.106 | 0.076 |

完整系统（C）相比离线 baseline（A）NDCG@10 提升 **10倍**，相比规则推荐多样性 ILD 提升 **1.9%**。
